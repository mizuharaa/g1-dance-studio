...
- 2026-08-05 (HANDOFF after a 2-week gap): **docs/HANDOFF_20260805.md is the single
  ...
  so other machines can pull the deployable unit. Stale agent worktrees pruned; unmerged
  hands work preserved on branch spike/hands-collision-vet (pushed). Remote renamed:
  git@github.com:mizuharaa/g1-dance-studio.git (old names redirect).
...
- 2026-07-16: **PIPELINE-TRUST + MIGRATION HANDOFF written** →
  ...
  FILE SINCE PRUNED in the 2026-07-17 docs cleanup — recover from git history if needed).
